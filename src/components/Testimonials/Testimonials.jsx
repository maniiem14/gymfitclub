    ...
    <div className='Testimonials' id='testimonials'>
        ...
        <div className="right-t">
            ...
            <div className="arrows">
                <img src={ leftArrow } onClick={ () => { selected===0 ? setSelected(tLength-1) : setSelected ((prev) => prev-1) }} alt="left arrow" />
                <img src={ rightArrow } onClick={ () => { selected=== tLength-1 ? setSelected(0) : setSelected ((prev) => prev+1) }} alt="right arrow" />
            </div>
        </div>
